...
> [!NOTE]
> Это **форк сообщества** [Immich](https://github.com/immich-app/immich) с дополнительными функциями. Информацию о Docker-образах, инструкции по переходу и полный список изменений смотрите в [основном README](../README.md).

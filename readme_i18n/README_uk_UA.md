...
> [!NOTE]
> Це **форк спільноти** [Immich](https://github.com/immich-app/immich) з додатковими функціями. Інформацію про Docker-образи, інструкції з переходу та повний список змін дивіться в [головному README](../README.md).

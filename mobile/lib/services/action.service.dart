...
class ActionService {
  ...
  Future<void> shareLink(List<String> remoteIds, BuildContext context, {String? spaceId}) async {
    unawaited(context.pushRoute(SharedLinkEditRoute(assetsList: remoteIds, spaceId: spaceId)));
  }

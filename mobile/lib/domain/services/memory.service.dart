...
class DriftMemoryService {
  ...
  DriftMemoryService(this._repository, this._apiRepository);
  ...
  Future<List<DriftMemory>> getMemoryLane(String ownerId) async {
    try {
  ...
  Future<List<DriftMemory>> getAll(String ownerId, {bool onlyFavorites = false}) async {
    try {

        ...
        await transaction(
          () => m.runMigrationSteps(
            ...
            steps: migrationSteps(
              ...
              from25To26: (m, v26) async {
                ...
                await remoteAssetEntity.update().write(
                  RemoteAssetEntityCompanion.custom(
                    durationMs: v26.remoteAssetEntity.durationMs * const Constant(1000),
                  ),
                );
              ...
              // Upstream Immich v3.0.2 (#29666) added an index on remote_asset_entity.uploaded_at
              // at its schema v31. That upstream v31 collides with the fork's own v31-v34, so it is
              // renumbered here to v35 — the next version after the fork's v34 — per the rebase skill's
              // "renumber the incoming upstream migration on top of the fork's" rule (installed clients

...
@RoutePage()
class PersonPickerPage extends HookConsumerWidget {
  const PersonPickerPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = useTextEditingController(text: ref.read(peoplePickerQueryProvider));
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          PickerSearchHeader(
            keyPrefix: 'person-picker',
            hintKey: 'filter_sheet_picker_search_people_hint',
            count: count,
            countLabelKey: 'filter_sheet_picker_people_count',

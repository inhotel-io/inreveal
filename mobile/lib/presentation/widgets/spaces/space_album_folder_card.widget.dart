              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'space_album_folder_albums_count'.t(context: context, args: {'count': albumCount.toString()}),
                  ...
                  child: PopupMenuButton<_FolderCardAction>(
                    ...
                    itemBuilder: (ctx) => [
                      PopupMenuItem(
                        ...
                        child: Text('space_album_folder_rename'.t(context: ctx)),
                      ),
                      PopupMenuItem(
                      ...
                      PopupMenuItem(
                        ...
                        child: Text('space_album_folder_delete'.t(context: ctx)),
                      ),
                    ],
                  ),
                ),

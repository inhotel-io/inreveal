...
class _FakeStoreService extends Fake implements StoreService {
  @override
  T get<T>(StoreKey<T> key, [T? defaultValue]) => defaultValue!;
}
...
void main() {
  ...
  setUp(() {
    ...
    sut = TimelineFactory(
      ...
      settingsService: SettingsService(storeService: _FakeStoreService()),
    );
  });

...
class AgentSearchUsersToolSuccessResponseStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const AgentSearchUsersToolSuccessResponseStatusEnum._(this.value);
  ...
  static const success = AgentSearchUsersToolSuccessResponseStatusEnum._(r'success');

  /// List of all possible values in this [enum][AgentSearchUsersToolSuccessResponseStatusEnum].
  static const values = <AgentSearchUsersToolSuccessResponseStatusEnum>[
    success,
  ];
...
class AgentSearchUsersToolSuccessResponseStatusEnumTypeTransformer {
  ...
  String encode(AgentSearchUsersToolSuccessResponseStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a AgentSearchUsersToolSuccessResponseStatusEnum.
  ///
  ...
  /// Singleton [AgentSearchUsersToolSuccessResponseStatusEnumTypeTransformer] instance.

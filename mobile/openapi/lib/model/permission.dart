...
enum Permission {
  ...
  sharedSpacePeriodCreate._(r'sharedSpace.create'),
  sharedSpacePeriodRead._(r'sharedSpace.read'),
  sharedSpacePeriodUpdate._(r'sharedSpace.update'),
  sharedSpacePeriodDelete._(r'sharedSpace.delete'),
  sharedSpaceMemberPeriodCreate._(r'sharedSpaceMember.create'),
  sharedSpaceMemberPeriodUpdate._(r'sharedSpaceMember.update'),
  sharedSpaceMemberPeriodDelete._(r'sharedSpaceMember.delete'),
  sharedSpaceAssetPeriodCreate._(r'sharedSpaceAsset.create'),
  sharedSpaceAssetPeriodRead._(r'sharedSpaceAsset.read'),
  sharedSpaceAssetPeriodDelete._(r'sharedSpaceAsset.delete'),
  sharedSpaceLibraryPeriodCreate._(r'sharedSpaceLibrary.create'),
  sharedSpaceLibraryPeriodDelete._(r'sharedSpaceLibrary.delete'),
  ...
  userGroupPeriodDelete._(r'userGroup.delete'),
  ...
  Permission? decode(dynamic data, {bool allowNull = true}) {
    ...
    if (data != null) {
      switch (data) {
        ...
        case r'userGroup.delete': return Permission.userGroupPeriodDelete;

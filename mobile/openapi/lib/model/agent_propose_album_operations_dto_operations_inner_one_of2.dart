...
class AgentProposeAlbumOperationsDtoOperationsInnerOneOf2 {
  ...
  AgentAlbumRemoveAssetsOperationType type;
  ...
  @override
  String toString() => 'AgentProposeAlbumOperationsDtoOperationsInnerOneOf2[type=$type, summary=$summary, targetKind=$targetKind, targetId=$targetId, temporaryTargetId=$temporaryTargetId, assetSource=$assetSource, assetIds=$assetIds, assetSelectionHandleId=$assetSelectionHandleId, riskLevel=$riskLevel, enabled=$enabled, payload=$payload]';
  ...
  static AgentProposeAlbumOperationsDtoOperationsInnerOneOf2? fromJson(dynamic value) {
    ...
    if (value is Map) {
      ...
      return AgentProposeAlbumOperationsDtoOperationsInnerOneOf2(
        type: AgentAlbumRemoveAssetsOperationType.fromJson(json[r'type'])!,

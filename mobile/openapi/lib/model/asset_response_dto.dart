...
class AssetResponseDto {
  ...
  AssetResponseDto({
    ...
    this.resolvedSpaceId = const Optional.absent(),
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  Optional<String?> resolvedSpaceId;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.resolvedSpaceId.isPresent) {
      final value = this.resolvedSpaceId.value;
      json[r'resolvedSpaceId'] = value;
    }
  ...
  static AssetResponseDto? fromJson(dynamic value) {
    ...
    if (value is Map) {
      ...
      return AssetResponseDto(
        ...
        resolvedSpaceId: json.containsKey(r'resolvedSpaceId') ? Optional.present(mapValueOfType<String>(json, r'resolvedSpaceId')) : const Optional.absent(),

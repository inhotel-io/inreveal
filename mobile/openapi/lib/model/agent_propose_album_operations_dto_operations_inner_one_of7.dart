...
class AgentProposeAlbumOperationsDtoOperationsInnerOneOf7 {
  ...
  @override
  String toString() => 'AgentProposeAlbumOperationsDtoOperationsInnerOneOf7[type=$type, summary=$summary, targetKind=$targetKind, targetId=$targetId, temporaryTargetId=$temporaryTargetId, assetIds=$assetIds, assetSelectionHandleId=$assetSelectionHandleId, riskLevel=$riskLevel, enabled=$enabled, payload=$payload]';

...
class AgentProposeAlbumOperationsDtoOperationsInnerOneOf3 {
  ...
  AgentAlbumUpdateDetailsOperationType type;
  ...
  AgentProposeAlbumOperationsDtoOperationsInnerOneOf3Payload payload;
  ...
  @override
  String toString() => 'AgentProposeAlbumOperationsDtoOperationsInnerOneOf3[type=$type, summary=$summary, targetKind=$targetKind, targetId=$targetId, riskLevel=$riskLevel, enabled=$enabled, payload=$payload]';
  ...
  static AgentProposeAlbumOperationsDtoOperationsInnerOneOf3? fromJson(dynamic value) {
    ...
    if (value is Map) {
      ...
      return AgentProposeAlbumOperationsDtoOperationsInnerOneOf3(
        type: AgentAlbumUpdateDetailsOperationType.fromJson(json[r'type'])!,
        ...
        payload: AgentProposeAlbumOperationsDtoOperationsInnerOneOf3Payload.fromJson(json[r'payload'])!,
      );
    }
    return null;
  }

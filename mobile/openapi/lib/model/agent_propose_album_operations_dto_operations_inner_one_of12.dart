...
class AgentProposeAlbumOperationsDtoOperationsInnerOneOf12 {
  ...
  @override
  String toString() => 'AgentProposeAlbumOperationsDtoOperationsInnerOneOf12[type=$type, summary=$summary, targetKind=$targetKind, targetId=$targetId, temporaryTargetId=$temporaryTargetId, assetIds=$assetIds, riskLevel=$riskLevel, enabled=$enabled, payload=$payload]';

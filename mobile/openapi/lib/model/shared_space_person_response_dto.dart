...
class SharedSpacePersonResponseDto {
  ...
  SharedSpacePersonResponseDto({
    ...
    this.representativeFaceSource = const SharedSpacePersonResponseDtoRepresentativeFaceSourceEnum._('auto'),
  ...
  static SharedSpacePersonResponseDto? fromJson(dynamic value) {
    ...
    if (value is Map) {
      ...
      return SharedSpacePersonResponseDto(
        ...
        representativeFaceSource: SharedSpacePersonResponseDtoRepresentativeFaceSourceEnum.fromJson(json[r'representativeFaceSource']) ?? 'auto',

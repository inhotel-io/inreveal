...
class AgentSearchAssetResult {
  /// Returns a new [AgentSearchAssetResult] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AgentSearchAssetResult &&
  ...
  @override
  String toString() => 'AgentSearchAssetResult[exifInfo=$exifInfo, fileCreatedAt=$fileCreatedAt, fileModifiedAt=$fileModifiedAt, id=$id, isFavorite=$isFavorite, localDateTime=$localDateTime, originalFileName=$originalFileName, ownerId=$ownerId, tags=$tags, type=$type, visibility=$visibility]';
  ...
  /// Returns a new [AgentSearchAssetResult] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AgentSearchAssetResult? fromJson(dynamic value) {
    upgradeDto(value, "AgentSearchAssetResult");
    if (value is Map) {
      final json = value.cast<String, dynamic>();

      return AgentSearchAssetResult(
  ...
  static List<AgentSearchAssetResult> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AgentSearchAssetResult>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AgentSearchAssetResult.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AgentSearchAssetResult> mapFromJson(dynamic json) {
    final map = <String, AgentSearchAssetResult>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AgentSearchAssetResult.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AgentSearchAssetResult-objects as value to a dart map
  static Map<String, List<AgentSearchAssetResult>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AgentSearchAssetResult>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AgentSearchAssetResult.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }

...
class AgentProposeAlbumOperationsDtoOperationsInnerOneOf24 {
  ...
  AgentProposeAlbumOperationsDtoOperationsInnerOneOf24Payload payload;
  ...
  @override
  String toString() => 'AgentProposeAlbumOperationsDtoOperationsInnerOneOf24[type=$type, summary=$summary, targetKind=$targetKind, targetId=$targetId, temporaryTargetId=$temporaryTargetId, assetSource=$assetSource, assetIds=$assetIds, assetSelectionHandleId=$assetSelectionHandleId, riskLevel=$riskLevel, enabled=$enabled, payload=$payload]';
  ...
  static AgentProposeAlbumOperationsDtoOperationsInnerOneOf24? fromJson(dynamic value) {
    ...
    if (value is Map) {
      ...
      return AgentProposeAlbumOperationsDtoOperationsInnerOneOf24(
        ...
        payload: AgentProposeAlbumOperationsDtoOperationsInnerOneOf24Payload.fromJson(json[r'payload'])!,
      );
    }
    return null;
  }

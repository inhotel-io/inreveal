...
class AgentProposeAlbumOperationsDtoOperationsInnerOneOf6 {
  ...
  @override
  String toString() => 'AgentProposeAlbumOperationsDtoOperationsInnerOneOf6[type=$type, summary=$summary, targetKind=$targetKind, targetId=$targetId, temporaryTargetId=$temporaryTargetId, assetIds=$assetIds, assetSelectionHandleId=$assetSelectionHandleId, riskLevel=$riskLevel, enabled=$enabled, payload=$payload]';

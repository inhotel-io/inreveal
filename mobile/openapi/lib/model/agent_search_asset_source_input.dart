...
class AgentSearchAssetSourceInput {
  ...
  AgentSearchAssetSourceInputMaterializationEnum? materialization;

  AgentSearchAssetSourceInputModeEnum? mode;

  AgentSearchAssetSourceInputOrderEnum? order;
  ...
  static AgentSearchAssetSourceInput? fromJson(dynamic value) {
    ...
    if (value is Map) {
      ...
      return AgentSearchAssetSourceInput(
        ...
        materialization: AgentSearchAssetSourceInputMaterializationEnum.fromJson(json[r'materialization']),
        mode: AgentSearchAssetSourceInputModeEnum.fromJson(json[r'mode']),
        order: AgentSearchAssetSourceInputOrderEnum.fromJson(json[r'order']),
...
/// Transformation class that can [encode] an instance of [AgentSearchAssetSourceInputMaterializationEnum] to String,
...
/// Transformation class that can [encode] an instance of [AgentSearchAssetSourceInputModeEnum] to String,
...
/// Transformation class that can [encode] an instance of [AgentSearchAssetSourceInputOrderEnum] to String,

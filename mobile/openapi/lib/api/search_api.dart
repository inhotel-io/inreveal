...
class SearchApi {
  ...
  Future<Response> getFilterSuggestionsWithHttpInfo({ String? albumId, String? city, String? country, bool? isFavorite, bool? isInAlbum, bool? isNotInAlbum, String? make, AssetTypeEnum? mediaType, String? model, List<String>? personIds, int? rating, String? spaceId, List<String>? tagIds, DateTime? takenAfter, DateTime? takenBefore, bool? withSharedSpaces, Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [bool] withSharedSpaces:
  ///   Include shared spaces the user is a member of
  Future<FilterSuggestionsResponseDto?> getFilterSuggestions({ String? albumId, String? city, String? country, bool? isFavorite, bool? isInAlbum, bool? isNotInAlbum, String? make, AssetTypeEnum? mediaType, String? model, List<String>? personIds, int? rating, String? spaceId, List<String>? tagIds, DateTime? takenAfter, DateTime? takenBefore, bool? withSharedSpaces, Future<void>? abortTrigger, }) async {
    final response = await getFilterSuggestionsWithHttpInfo(albumId: albumId, city: city, country: country, isFavorite: isFavorite, isInAlbum: isInAlbum, isNotInAlbum: isNotInAlbum, make: make, mediaType: mediaType, model: model, personIds: personIds, rating: rating, spaceId: spaceId, tagIds: tagIds, takenAfter: takenAfter, takenBefore: takenBefore, withSharedSpaces: withSharedSpaces, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] withSharedSpaces:
  ///   Include suggestions from shared spaces the user is a member of
  Future<Response> getTagSuggestionsWithHttpInfo({ String? spaceId, DateTime? takenAfter, DateTime? takenBefore, bool? withSharedSpaces, Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [bool] withSharedSpaces:
  ///   Include suggestions from shared spaces the user is a member of
  Future<List<TagSuggestionResponseDto>?> getTagSuggestions({ String? spaceId, DateTime? takenAfter, DateTime? takenBefore, bool? withSharedSpaces, Future<void>? abortTrigger, }) async {
    final response = await getTagSuggestionsWithHttpInfo(spaceId: spaceId, takenAfter: takenAfter, takenBefore: takenBefore, withSharedSpaces: withSharedSpaces, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] withSharedSpaces:
  ///   Include shared spaces the user is a member of
  Future<Response> searchLargeAssetsWithHttpInfo({ List<String>? albumIds, String? city, String? country, DateTime? createdAfter, DateTime? createdBefore, bool? isEncoded, bool? isFavorite, bool? isInAlbum, bool? isMotion, bool? isNotInAlbum, bool? isOffline, String? lensModel, String? libraryId, String? make, int? minFileSize, String? model, String? ocr, List<String>? personIds, int? rating, int? size, String? spaceId, List<String>? spacePersonIds, String? state, List<String>? tagIds, DateTime? takenAfter, DateTime? takenBefore, DateTime? trashedAfter, DateTime? trashedBefore, AssetTypeEnum? type, DateTime? updatedAfter, DateTime? updatedBefore, AssetVisibility? visibility, bool? withDeleted, bool? withExif, bool? withSharedSpaces, Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [bool] withSharedSpaces:
  ///   Include shared spaces the user is a member of
  Future<List<AssetResponseDto>?> searchLargeAssets({ List<String>? albumIds, String? city, String? country, DateTime? createdAfter, DateTime? createdBefore, bool? isEncoded, bool? isFavorite, bool? isInAlbum, bool? isMotion, bool? isNotInAlbum, bool? isOffline, String? lensModel, String? libraryId, String? make, int? minFileSize, String? model, String? ocr, List<String>? personIds, int? rating, int? size, String? spaceId, List<String>? spacePersonIds, String? state, List<String>? tagIds, DateTime? takenAfter, DateTime? takenBefore, DateTime? trashedAfter, DateTime? trashedBefore, AssetTypeEnum? type, DateTime? updatedAfter, DateTime? updatedBefore, AssetVisibility? visibility, bool? withDeleted, bool? withExif, bool? withSharedSpaces, Future<void>? abortTrigger, }) async {
  ...
  /// * [bool] withSharedSpaces:
  ///   Include shared spaces the user is a member of
  Future<Response> searchPersonWithHttpInfo(String name, { bool? withHidden, bool? withSharedSpaces, Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [bool] withSharedSpaces:
  ///   Include shared spaces the user is a member of
  Future<List<PersonResponseDto>?> searchPerson(String name, { bool? withHidden, bool? withSharedSpaces, Future<void>? abortTrigger, }) async {
    final response = await searchPersonWithHttpInfo(name, withHidden: withHidden, withSharedSpaces: withSharedSpaces, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// Retrieve filter facets and timeline buckets for the full smart-search result set.
  ///
  /// Note: This method returns the HTTP [Response].
  ///
  /// Parameters:
  ///
  /// * [SmartSearchFacetsDto] smartSearchFacetsDto (required):
  Future<Response> searchSmartFacetsWithHttpInfo(SmartSearchFacetsDto smartSearchFacetsDto, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
    final apiPath = r'/search/smart/facets';

    // ignore: prefer_final_locals
    Object? postBody = smartSearchFacetsDto;
  ...
  ///
  /// * [SmartSearchFacetsDto] smartSearchFacetsDto (required):
  Future<SmartSearchFacetsResponseDto?> searchSmartFacets(SmartSearchFacetsDto smartSearchFacetsDto, { Future<void>? abortTrigger, }) async {
    final response = await searchSmartFacetsWithHttpInfo(smartSearchFacetsDto, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'SmartSearchFacetsResponseDto',) as SmartSearchFacetsResponseDto;

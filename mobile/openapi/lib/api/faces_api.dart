...
class FacesApi {
  ...
  Future<Response> getFaceRepairClusterFacesWithHttpInfo(String personId, FaceRepairClusterFacesRequestDto faceRepairClusterFacesRequestDto,) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [FaceRepairClusterFacesRequestDto] faceRepairClusterFacesRequestDto (required):
  Future<FaceRepairClusterFacesResponseDto?> getFaceRepairClusterFaces(String personId, FaceRepairClusterFacesRequestDto faceRepairClusterFacesRequestDto,) async {
    final response = await getFaceRepairClusterFacesWithHttpInfo(personId, faceRepairClusterFacesRequestDto,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [String] personId (required):
  Future<Response> getFaceRepairPersonFacesWithHttpInfo(String personId,) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [String] personId (required):
  Future<FaceRepairPersonFacesDto?> getFaceRepairPersonFaces(String personId,) async {
    final response = await getFaceRepairPersonFacesWithHttpInfo(personId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.

...
class AgentRunnerApi {
  AgentRunnerApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<AgentRunnerStatusDto?> getAgentRunnerStatus() async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'AgentRunnerStatusDto',) as AgentRunnerStatusDto;

...
patch --no-backup-if-mismatch -u ../mobile/openapi/lib/model/agent_operation_plan_apply_request_dto.dart <./patch/agent_operation_plan_apply_request_dto.dart.patch
...
# Render fork agent tool response DTOs (union-variant fields must stay nullable)

  ...
  >
    ...
    <div class="mb-7 flex min-h-[26px] items-center justify-between gap-4">
      ...
      <div class="inline-flex items-center gap-2 text-sm font-bold tracking-tight">
        ...
        >
          <svg class="h-[13px] w-[13px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
    ...
    {#if step === 0}
      <div class="flex flex-col gap-5">
        ...
        >
          <svg class="h-[30px] w-[30px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="flex flex-col gap-3">
          <div class="flex items-start gap-3">
            <span class="flex h-8 w-8 flex-none items-center justify-center rounded-[9px] bg-primary/10 text-primary">
              <svg class="h-[17px] w-[17px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="mt-1 flex items-center justify-between gap-3 border-t border-gray-200 pt-5 dark:border-gray-700">
          <span class="inline-flex max-w-[30ch] items-center gap-1.5 text-[12.5px] font-medium leading-snug text-gray-400 dark:text-gray-500">
    ...
    {:else if step === 1}
      <div class="flex flex-col gap-4">
        <div>
          <p class="mb-3 text-[12px] font-bold uppercase tracking-[0.09em] text-primary">{$t('assistant_onboarding_connect_eyebrow')}</p>
          <h2 class="text-[30px] font-extrabold leading-[1.08] tracking-[-0.025em] text-gray-900 dark:text-white">{$t('assistant_onboarding_connect_title')}</h2>
          <p class="mt-2.5 max-w-[46ch] text-[15.5px] leading-relaxed text-gray-500 dark:text-neutral-400">{$t('assistant_onboarding_connect_subtitle')}</p>
        </div>
      ...
      <div class="flex flex-col gap-4">
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-700">
          ...
          <div class="flex items-center gap-3 bg-white px-4 py-3.5 dark:bg-immich-dark-gray">
            <span class="flex h-[30px] w-[30px] flex-none items-center justify-center rounded-lg bg-primary/10 text-primary">
          ...
          <!-- Access row -->
          <div class="flex items-center gap-3 border-t border-gray-200 bg-white px-4 py-3.5 dark:border-gray-700 dark:bg-immich-dark-gray">
            <span class="flex h-[30px] w-[30px] flex-none items-center justify-center rounded-lg bg-primary/10 text-primary">
              <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">

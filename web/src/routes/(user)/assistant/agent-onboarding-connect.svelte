...
<div class="flex flex-col gap-4">
  ...
  <div role="group" aria-label="Provider">
    ...
    >
      ...
      >
        <svg class="h-[11px] w-[11px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
      ...
      <span class="flex min-w-0 flex-1 flex-col gap-1">
        <span class="flex flex-wrap items-center gap-2">
          <span class="text-[14.5px] font-bold tracking-[-0.01em] text-gray-900 dark:text-white">{$t('assistant_onboarding_provider_local')}</span>
          <span class="rounded-full bg-green-50 px-2 py-0.5 text-[10.5px] font-bold uppercase tracking-[0.04em] text-green-600 dark:bg-green-950 dark:text-green-400">
            {$t('assistant_onboarding_provider_most_private')}
          </span>
        </span>
        <span class="max-w-[48ch] text-xs leading-snug text-gray-500 dark:text-neutral-400">{$t('assistant_onboarding_provider_local_meta')}</span>
      </span>
    </button>

    <!-- "or use a cloud provider" divider -->
    <div class="mb-2.5 mt-0.5 flex items-center gap-3 text-[11.5px] font-semibold uppercase tracking-[0.03em] text-gray-400 dark:text-gray-500">
        ...
        >
          ...
          >
            ...
            {:else if id === 'anthropic'}
              <!-- Anthropic logo -->
              <svg class="h-[19px] w-[19px] text-gray-800 dark:text-gray-100" viewBox="0 0 24 24" fill="currentColor">
                <path d="M14.6 4h-2.9l5.3 16h2.9L14.6 4Zm-7.4 0L1.9 20h3l1.05-3.2h5.55L12.5 20h3L10.2 4H7.2Zm-.45 9.7 1.9-5.8 1.9 5.8H6.75Z" />
              </svg>
            {:else}
              <!-- Generic endpoint icon -->
              <svg class="h-[19px] w-[19px] text-gray-500 dark:text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="mt-1.5 flex items-center gap-2.5">
      ...
      {#if status === 'testing'}
        <span class="flex items-center gap-2 text-[13px] font-semibold text-gray-500 dark:text-neutral-400">
          <span class="h-[15px] w-[15px] animate-spin rounded-full border-2 border-gray-300 border-t-primary dark:border-gray-600 dark:border-t-primary"></span>

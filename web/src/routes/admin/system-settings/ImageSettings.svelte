<script lang="ts">
  ...
  import { Colorspace, ImageFormat, ImagePresetPosition, type SystemConfigImagePresetDto } from '@immich/sdk';
  ...
  const addPreset = () => {
    ...
    const preset: SystemConfigImagePresetDto = {
      aspectRatio: '16:9',
  ...
  const isPresetEdited = (name: string, field: keyof SystemConfigImagePresetDto) => {

...
// gallery-fork: upstream removed this in #30768 as unused on their side. The fork's
// album-factory builds `albumUsers` from it, and SpaceLinkAlbumModal.spec.ts uses it directly.

...
<nav
  ...
  tabindex="-1"
  class="relative z-10 w-0 immich-scrollbar overflow-x-hidden overflow-y-auto bg-light pt-8 transition-all duration-200 sidebar:w-64"
...
>
  <div class="flex h-max min-h-full flex-col gap-1 ps-2 pe-6">
    {@render children?.()}
  </div>
</nav>

...
export const newAssetRepositoryMock = (): Mocked<RepositoryInterface<AssetRepository>> => {
  return {
    ...
    getForDerivedImage: vitest.fn(),
    getDerivedFile: vitest.fn(),
    upsertDerivedFile: vitest.fn(),
    getDerivedFilePaths: vitest.fn().mockResolvedValue([]),
    deleteDerivedFilesForAsset: vitest.fn().mockResolvedValue([]),
    deleteStaleDerivedFiles: vitest.fn().mockResolvedValue([]),

...
// gallery-fork: upstream removed this factory in #30772 as unused on their side, but the
// fork's metadata.service.spec.ts still drives sidecar-write cases through it.
...
const sharedSpacePersonFactory = (data: Partial<SharedSpacePerson> = {}): SharedSpacePerson => ({
  ...
  birthDateSourceProfileType: null,
  birthDateSourceUpdatedAt: null,
  faceCount: 0,
  identityId: null,
  assetCount: 0,
  nameSource: 'none',
  nameSourceProfileId: null,
  nameSourceProfileType: null,
  nameSourceUpdatedAt: null,
  createdAt: newDate(),
  updatedAt: newDate(),
  updateId: newUuidV7(),
  ...data,

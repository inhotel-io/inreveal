...
export const columns = {
  ...
  // L5: same field set as syncAsset, minus isFavorite — LibraryAssetSync selects isFavorite separately
  // via an ownership CASE (a member syncing another owner's linked library must not see their true flag).
  syncLibraryAsset: [
    'asset.id',
    'asset.ownerId',
    'asset.originalFileName',

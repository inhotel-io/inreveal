...
export type SharedSpaceAlbumFolderDto = {
    createdAt: string;
...
export type SharedSpaceAlbumFolderCreateDto = {
    /** Folder name */
    name: string;
    /** Parent folder ID; omit or null for the space root */
    parentId?: string | null;
};
export type SharedSpaceBulkFolderIdsDto = {
    /** IDs to process */
    ids: string[];
};
export type SharedSpaceBulkFolderParentDto = {
    /** IDs to process */
    ids: string[];
    /** Destination parent folder ID; null moves the folders to the root */
    parentId: string | null;
};
export type SharedSpaceAlbumFolderUpdateDto = {
    /** New folder name */
    name?: string;
...
export type SharedSpaceBulkAlbumTimelineDto = {
    /** IDs to process */
    ids: string[];
 ...
 */
export function getSharedSpaceAlbumFolders({ id }: {
    id: string;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: SharedSpaceAlbumFolderDto[];
    }>(`/shared-spaces/${encodeURIComponent(id)}/album-folders`, {
        ...opts
    }));
}
/**
 ...
 */
export function createSharedSpaceAlbumFolder({ id, sharedSpaceAlbumFolderCreateDto }: {
    id: string;
    sharedSpaceAlbumFolderCreateDto: SharedSpaceAlbumFolderCreateDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 201;
        data: SharedSpaceAlbumFolderDto;
    }>(`/shared-spaces/${encodeURIComponent(id)}/album-folders`, oazapfts.json({
        ...opts,
        method: "POST",
        body: sharedSpaceAlbumFolderCreateDto
    })));
}
/**
 * Delete several album folders
 */
export function bulkDeleteAlbumFolders({ id, sharedSpaceBulkFolderIdsDto }: {
    id: string;
    sharedSpaceBulkFolderIdsDto: SharedSpaceBulkFolderIdsDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: BulkIdResponseDto[];
    }>(`/shared-spaces/${encodeURIComponent(id)}/album-folders/bulk-delete`, oazapfts.json({
        ...opts,
        method: "POST",
        body: sharedSpaceBulkFolderIdsDto
    })));
}
/**
 * Move several album folders to a new parent
 */
export function bulkMoveAlbumFolders({ id, sharedSpaceBulkFolderParentDto }: {
    id: string;
    sharedSpaceBulkFolderParentDto: SharedSpaceBulkFolderParentDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: BulkIdResponseDto[];
    }>(`/shared-spaces/${encodeURIComponent(id)}/album-folders/bulk-parent`, oazapfts.json({
        ...opts,
        method: "PUT",
        body: sharedSpaceBulkFolderParentDto
    })));
}
/**
 * Delete an album folder
 */
export function deleteSharedSpaceAlbumFolder({ folderId, id }: {
    folderId: string;
    id: string;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchText(`/shared-spaces/${encodeURIComponent(id)}/album-folders/${encodeURIComponent(folderId)}`, {
        ...opts,
        method: "DELETE"
    }));
}
 ...
 */
export function updateSharedSpaceAlbumFolder({ folderId, id, sharedSpaceAlbumFolderUpdateDto }: {
    folderId: string;
    id: string;
    sharedSpaceAlbumFolderUpdateDto: SharedSpaceAlbumFolderUpdateDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchText(`/shared-spaces/${encodeURIComponent(id)}/album-folders/${encodeURIComponent(folderId)}`, oazapfts.json({
        ...opts,
        method: "PATCH",
        body: sharedSpaceAlbumFolderUpdateDto
    })));
}
/**
...
export function bulkSetAlbumFolder({ id, sharedSpaceBulkAlbumFolderMoveDto }: {
    id: string;
    sharedSpaceBulkAlbumFolderMoveDto: SharedSpaceBulkAlbumFolderMoveDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: BulkIdResponseDto[];
    }>(`/shared-spaces/${encodeURIComponent(id)}/albums/bulk-folder`, oazapfts.json({
        ...opts,
        method: "PUT",
        body: sharedSpaceBulkAlbumFolderMoveDto
    })));
}
/**
 * Set the timeline flag for several linked albums
 */
export function bulkSetAlbumTimeline({ id, sharedSpaceBulkAlbumTimelineDto }: {
    id: string;
    sharedSpaceBulkAlbumTimelineDto: SharedSpaceBulkAlbumTimelineDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: BulkIdResponseDto[];
    }>(`/shared-spaces/${encodeURIComponent(id)}/albums/bulk-timeline`, oazapfts.json({
        ...opts,
        method: "PUT",
        body: sharedSpaceBulkAlbumTimelineDto
    })));
}
/**
 * Unlink several albums from a shared space
 */
export function bulkUnlinkAlbums({ id, sharedSpaceBulkAlbumIdsDto }: {
    id: string;
    ...
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: BulkIdResponseDto[];
    }>(`/shared-spaces/${encodeURIComponent(id)}/albums/bulk-unlink`, oazapfts.json({
        ...opts,
        method: "POST",
 ...
 */
export function setSharedSpaceAlbumFolder({ albumId, id, sharedSpaceAlbumFolderMoveAlbumDto }: {
    albumId: string;
    id: string;
    sharedSpaceAlbumFolderMoveAlbumDto: SharedSpaceAlbumFolderMoveAlbumDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchText(`/shared-spaces/${encodeURIComponent(id)}/albums/${encodeURIComponent(albumId)}/folder`, oazapfts.json({
        ...opts,
        method: "PUT",

...
const runnerBehaviorPrompt = [
  ...
  'Gallery MCP validation or denied results with retryable correction hints are recoverable: retry with corrected arguments once, but approval-required results pause for Gallery approval. A first-pass tool validation mistake is not an internal Gallery issue.',
